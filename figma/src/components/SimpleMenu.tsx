  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className={cn(
          "inline-flex items-center justify-center gap-2 rounded-full bg-foreground/90 text-background transition hover:bg-foreground",
          variant === "pill" ? "h-12 px-6" : "h-11 w-11",
          triggerClassName
        )}
      >
        {triggerIcon}
        {variant === "icon" && <span className="sr-only">{triggerLabel}</span>}
      </button>
