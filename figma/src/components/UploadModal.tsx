...
export function UploadModal({
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent
        className="max-w-3xl rounded-[40px] border-0 p-10"
      ...
      >
        ...
        <Tabs defaultValue="json" className="mt-6">
          <TabsList className="grid grid-cols-3 rounded-full bg-foreground/[0.06] p-1">
          ...
          <TabsContent value="json" className="space-y-6 pt-4">
            <div className="space-y-3">
              ...
              <select
                className="w-full rounded-full border-0 bg-foreground/[0.05] px-5 py-3 text-base text-foreground transition focus:bg-foreground/[0.1] focus:outline-none"
                value={jsonLocation}
            ...
            <div
              className="space-y-4 rounded-[36px] p-10 text-center"
              style={{ background: "var(--panel-surface)", boxShadow: "var(--panel-shadow)" }}
            >
